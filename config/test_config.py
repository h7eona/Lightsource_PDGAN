...
class TestConfig(BaseConfig):
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--test_image", default="/root/dataset/ReflectionRemoval/LightSource/SSM_syn/val/T", type=str, help="the dir of test image"
        )
        parser.add_argument(
            "--mask_image", default="/root/dataset/ReflectionRemoval/LightSource/SSM_syn/val/R", type=str, help="the dir of mask image"
        )
        parser.add_argument(
