...
class BaseConfig:
    ...
    def initialize(self, parser):
        ...
        parser.add_argument(
            "--gt_root",
            type=str,
            default="/root/dataset/ReflectionRemoval/LightSource/SSM_syn/T",
        ...
        parser.add_argument(
            "--mask_root",
            type=str,
            default="/root/dataset/ReflectionRemoval/LightSource/SSM_syn/R",
        ...
        parser.add_argument(
            "--pre_ckpt_PConv_EN_dir", default="/root/workplace/PD-GAN-2/pre-train/ENmodel.pth", type=str, help="max image size"
        )
        parser.add_argument(
            "--pre_ckpt_PConv_DE_dir", default="/root/workplace/PD-GAN-2/pre-train/DEmodel.pth", type=str, help="max image size"
        )
